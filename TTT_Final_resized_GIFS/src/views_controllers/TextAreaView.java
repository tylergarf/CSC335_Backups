...
public class TextAreaView extends BorderPane implements OurObserver {
	...
	private Image winningGif = new Image(getClass().getResourceAsStream("office.gif"),400,200,true,true);

	private ImageView gifImageView = new ImageView(winningGif);
	
	private Image tieGif = new Image(getClass().getResourceAsStream("tie.gif"),400,295,true,true);
